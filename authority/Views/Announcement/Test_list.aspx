    ...
    <div class="news_listM"><img src="/images/cp-middle.png" /></div>
     ...
     <div class="news_listR">
          ...
          <div class="news_listR1">
              ...
              <h4>查老赖公告<b>我的位置：<a href="/">首页</a>&gt;&gt;查老赖公告</b></h4>
                  ...
                  <%foreach (DBC.Announcement item in ViewBag.announcementlist)
                    {
                        %>
                    <dl>
                      <dt><a href="/announcement/details?id=<%=item.ID %>" target="_blank" title=""><%=item.Title %></a><span>[<%=DateTime.Now.ToString("MM-dd")%>]</span></dt>
                      <dd><%=item.Content %></dd>
                   </dl>
                        <%
                    } %>
